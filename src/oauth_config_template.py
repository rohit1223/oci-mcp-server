...
OAUTH_CONFIG = {
    ...
    "authorization_endpoint": "https://idcs-YOUR-TENANT-ID.identity.oraclecloud.com/oauth2/v1/authorize",
    "token_endpoint": "https://idcs-YOUR-TENANT-ID.identity.oraclecloud.com/oauth2/v1/token",
...
OAUTH_CONFIG = {
    ...
    "redirect_uri": "https://myapigateway.apigateway.us-ashburn-1.oci.customer-oci.com/mcp_no_auth/auth/callback",
    "scope": "openid https://myapigateway.apigateway.us-ashburn-1.oci.customer-oci.com/api_gateway_access",
    "audience": "https://myapigateway.apigateway.us-ashburn-1.oci.customer-oci.com"
}
"""